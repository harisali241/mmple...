				...
				<div class="form-header-inner">
					<div class="col-sm-6">
			 		...
			 		<div class="col-sm-6 action_btn">
				 		...
				 		<button type="submit" class="btn submitBtn save-button" id="add_showtime">Save Changes</button>
				 		{{-- <form action="{{ url('showTime/'.$showTime->id) }}" method="post" id="delete{{$showTime->id}}">
	                   		{{ csrf_field() }}
	                   		{{method_field("DELETE")}}
							<input type="hidden" class="id_to_delete" value="{{ $showTime->id }}"><a style="cursor:pointer;" data-toggle="modal" data-target=".delete_confirm_modal"><img class="img_delete" src="{{ asset('assets/images/delete_icon.png') }}" style="margin-bottom: 10px;" /></a>
						</form>	 --}}
			 		</div>
			 	</div>
		 	</div>
			...
			<div class="col-md-12">	
				...
				<div class="col-md-12">	
					<div class="form-group">
						...
						<div class="col-sm-8">
							{!! Form::select('ticket_id', $tickets, null,['class' => 'form-control', 'required' => 'required']) !!}
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 nopadding" id="content1">
						...
						<div class="col-md-12 row-el">	
							<div class="form-group">
								...
								<div class="col-sm-8">
									{!! Form::text('dateTime', null,['id' => 'showtime_datetime', 'class' => 'form-control datetimepickers', 'value' => 'public', 'placeholder'=>'Insert date time', 'required'=>'required']) !!}
								</div>
							</div>
							<div class="clear"></div>
						</div>
